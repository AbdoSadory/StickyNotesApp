...
const StickerNote = () => {
  ...
  return (
    <div className={`${styles.parent}`} ref={note}>
      <div className={`${styles.header} m-0 p-0`}>
        ...
        <form className={`${styles.noteForm} text-end`} ref={formElement}>
        ...
        <div
          className={`${styles.btns_container} row justify-content-between align-items-center m-0 p-0`}
        >
          <div className={`${styles.btn} col-2 m-0 p-2`}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
              width="20"
      ...
      <div className={`${styles.note_body}`}>
        
      </div>
    </div>
  );
};
